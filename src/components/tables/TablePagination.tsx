...
export function TablePagination({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-3 px-6 py-4 border-t border-[#eef1f6]">
      ...
      <div className="flex gap-2 items-center flex-wrap justify-center">
        <button
          ...
          className="inline-flex items-center px-3 py-1.5 text-sm font-medium text-[#475569] border border-[#e2e8f0] rounded-lg hover:bg-[#f1f5f9] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
      ...
      <div className="flex items-center gap-2 text-sm text-[#64748b] justify-center sm:justify-end">
