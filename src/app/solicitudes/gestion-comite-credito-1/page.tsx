      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Listado solicitudes pendientes de Gestión Comité Crédito 1
          </h1>
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    const data = await solicitudesService.getSolicitudesParaComiteCredito1(
                      usuarioId,
                    );
                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <button
                              onClick={() =>
                                router.push(
                                  `/solicitudes/gestion-comite-credito-1/${solicitud.sol_id ?? solicitud.solicitud_id}/gestionar`,
                                )
                              }
