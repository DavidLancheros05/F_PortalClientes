...
export function ArchivoField({
  ...
  const preguntaFechaActiva = shouldShowFechaAsociada ? preguntaFechaAsociada : undefined;
              ...
              <CampoFechaVigencia
                ...
                onChange={(fecha) => {
                  ...
                  if (preguntaFechaActiva) {
                    validateField(preguntaFechaActiva.fp_id, getValidationRules(preguntaFechaActiva));
                  }
                }}
              />
