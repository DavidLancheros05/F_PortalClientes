...
import { Shield, User, Briefcase, TrendingUp, Building, FileText, PlusCircle } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const roleConfig = user ? getRolConfig(user.rol_id, user.rol?.nombre) : null;
        ...
        <div className="mb-8">
          ...
          {loading || !user || !roleConfig || !RoleIcon ? (
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-medium text-gray-900">Bienvenido, {user.nombre}</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="font-medium text-gray-900 group-hover:text-purple-700">Crear Cliente</span>
                    </div>
                  </button>
                  <button
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="font-medium text-gray-900 group-hover:text-purple-700">Ver Clientes</span>
                    </div>
                  </button>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="font-medium text-gray-900 group-hover:text-blue-700">Ver solicitudes</span>
                    </div>
                  </button>
                  <button
                    onClick={() => {
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="font-medium text-gray-900 group-hover:text-blue-700">Nueva solicitud</span>
                    </div>
                  </button>
                </div>
              </div>
                ...
                <div className="flex">
                  <button
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="font-medium text-gray-900 group-hover:text-amber-700">Revisar solicitudes</span>
                    </div>
                  </button>
                </div>
              </div>
